 ...
 * 日期选择器，可以指定日期的显示格式 
 */
public class DateChooserBox extends JPanel {
	...
	public static DateChooserBox getInstance() {
		return new DateChooserBox();
	}

	public static DateChooserBox getInstance(Date date) {
		return new DateChooserBox(date);
	}

	public static DateChooserBox getInstance(String format) {

		return new DateChooserBox(format);

	}

	public static DateChooserBox getInstance(Date date, String format) {

		return new DateChooserBox(date, format);
	 ...
	 */
	private DateChooserBox() {
		this(new Date());
	}

	private DateChooserBox(Date date) {
		this(date, "yyyy年MM月dd日");
	}

	private DateChooserBox(String format) {
		this(new Date(), format);
	}



	private DateChooserBox(Date date, String format) {
		initDate = date;
